(function(){
  ...
  */
  var pessoa = {name: 'Walter', lastName: 'Calegari'};
  var pessoa2 = {name: 'luiz', lastName: 'Calegari'};
  ...
  */
  function sum(){
    ...
    return Array.prototype.reduce.call(arguments, function(acumulate, actualItem){
      return +acumulate + +actualItem;
    });
  }
